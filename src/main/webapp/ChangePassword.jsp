...
<div class="col-xs-8 text-right menu-1">
                        <ul>
                            ...
                            <li >
                             <li class="active">   <a href="ChangeSetting.jsp">change-setting</a>
    ...
    <div class="container">
                    <div style="margin-top: 100px">
                        ...
                        <h2>${message}</h2>
            <form action="changepassword.ams"  method="post" style="border:1px solid #ccc">
                    <h1 style="color: goldenrod" bgcolor:green>change your password</h1>
                   ...
                   <div class="form-group row">
												...
												<div class="col-md-7">
														<input type="text" class="form-control" placeholder="Enter your mail id" name="EmailId" >
												</div>
										</div>
										...
										<div class="form-group row">
												...
												<div class="col-md-7">
														<input type="password" class="form-control" placeholder="Enter old mail password" name="oldPassword" >
												</div>
										</div>
										<div class="form-group row">
												<div class="col-md-4" style="padding-top: 12px">
												...
												<div class="col-md-7">
														<input type="password" class="form-control" placeholder="Enter new mail password" name="NewPassword" required>
												</div>
										</div>
										<div class="form-group row">
												<div class="col-md-4" style="padding-top: 12px">
												...
												<div class="col-md-7">
														<input type="password" class="form-control" placeholder="verify your new p/w" name="coonfirmPassword" required>
												</div>
										</div>
                <div class="form-group row">
                    <div class="col-md-1"></div>
                    <!-- <div class="col-md-4"> -->
                        <button type="submit" class="col-md-4 changebtn">Change</button>
                    <!-- </div>           -->
                    <div class="col-md-2"></div>
                     <!-- <div class="col-md-4"> -->
                        <button type="submit" class="col-md-4 cancelbtn">cancel</button>
                    <!-- </div> -->
                </div>
