...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 text-right menu-1">
                        <ul>
                            ...
                            <li><a href="SignInjsp">SignOut</a></li>
    ...
    <div class="container">
            ...
            <form action="/" style="border:1px solid #ccc">
                    <h1 style="background-color:rgb(255, 227, 71);" >CHANGE SETTING</h1>
				...
				<div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" placeholder="Enter phoneNo" name="phoneNo" required>
                    </div>
				</div>
               ...
               <!--   <div class="col-md-1"></div>  -->
                    <!-- <div class="col-md-4"> -->
                        ...
                        <!-- <button type="button" class="col-md-4 cancelbtn">Cancel</button> -->
                    <!-- </div>           -->
                    <div class="col-md-4"></div>
                     <!-- <div class="col-md-4"> -->
                            <button type="button" class="col-md-4 changebtn">Change</button>
                    <!-- </div> -->
                </div>
