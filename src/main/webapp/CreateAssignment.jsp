...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 text-right menu-1">
                        <ul>
                            ...
                            <li class="active"><a href="CreateAssignment.jsp">create-assignment</a></li>
    ...
    <div class="container">
                    <div style="margin-top: 100px">
                        ...
                        <h2>${message}</h2>
            <form action="createAssignment.ams" method="post" style="border:1px solid #ccc">
                    <h1 style="background-color:Tomato;">create Assignment</h1>
                    <p>Please fill the details below</p>
                    <hr>
                    <div class="form-group row" >
                        <div class="col-md-4" style="padding-top: 12px">
                            <label for="courses"></label><b>courses</b></label>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            ...
                            <optgroup label="Core Java">
                                    <option value="oop">OOPs Principals</option>
                                    <option value="str">Strings</option>
                                    <option value="thr">Thread</option>
                                    <option value="col">Collections</option>
                                    <option value="exc">Exception</option>
                                    <option value="lae">Lambda Expressions</option>
                                </optgroup>
                                <optgroup label="Hibernate">
                                    <option value="com">Component</option>
                                    <option value="orm">ORM's Problems</option>
                                    <option value="hql">HQL</option>
                                    <option value="cug">Custome Generator</option>
                                     <option value="cac">1st Level Cache</option>
                                    <option value="nq">Named Queries</option>
                                    <option value="hc">Hikari Configuration</option>
                                </optgroup>
                                
                                <optgroup label="Spring">
                                    <option value="spa">Spring Architecture</option>
                                    <option value="sob">Scope Of Bean</option>
                                    <option value="uns">Utilnamespace</option>
                                    <option value="das">Datasources</option>
                                    <option value="pfr">Properties file Reading</option>
                                    <option value="swo">Spring with ORM</option>
                                    <option value="spm">Spring-MVC</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <!-- <input type="text" class="form-control" placeholder="" name="" required> -->
                        <textarea class="form-control populate" name="description" rows="5" cols="10"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-4" style="padding-top: 12px">
                ...
                <div class="form-group row" >
                    <div class="col-md-4" style="padding-top: 12px">
                        <label for="update type"></label><b>updateType</b></label>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2"></div>
                     <!-- <div class="col-md-4"> -->
                        <button type="submit" class="col-md-4 signupbtn">create</button>
                    <!-- </div> -->
                </div>
