...
<body>
    ...
    <div class="container">
                    <div style="margin-top: 100px">
                        ...
                        <h2>${msg}</h2>
            <form action="uploadAssignment.ams" method="post" enctype="multipart/form-data"   style="border:1px solid #ccc">
                    <h1 style="background-color:Tomato;">Upload Assignment</h1>
                    <p>come here to upload your assignment</p>
                    <hr>
                    ...
                    <div class="col-md-7">
                        <input type="number" class="form-control" placeholder="" name="contactNo" required>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-4" style="padding-top: 12px">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2"></div>
                     <!-- <div class="col-md-4"> -->
                        <button type="submit" class="col-md-4 signupbtn">Upload</button>
                    <!-- </div> -->
                </div>
