...
<body>
    ...
    <div class="container">
            ...
            <h2>${msg}</h2>
                    <form action="login.ams"  method="post"  style="border:1px solid #ccc">
                    <h1 style="background-color:Tomato;">Sign in</h1>
                    <p>Login Please</p>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="password" class="form-control" placeholder="Enter mail password" name="password" required>
                    </div>
                </div>
                <div class="form-group row">
