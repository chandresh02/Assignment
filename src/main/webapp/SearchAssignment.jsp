...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8 text-right menu-1">
                            <ul>
                                ...
                                <li  class="active"><a href="SearchAssignment.jsp">search</a></li>
    ...
    <div class="container">
            ...
            <form action="searchAssignment.ams" method="post" style="border:1px solid #ccc">
                    <h1 style="background-color:Tomato;">Search</h1>
                    <p>Search the corresponding Assignment here</p>
                    <hr>
                    <div class="form-group row" >
                        <div class="col-md-4" style="padding-top: 12px">
                            <label for="pin"></label><b>Pin</b></label>
                        </div>
        
                        <div class="col-md-7">
                            <input type="text" class="form-control" placeholder="Enter Valid Pin" name="pin" required>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2"></div>
                     <!-- <div class="col-md-4"> -->
                        <button type="submit" class="col-md-4 signupbtn">Search</button>
                    <!-- </div> -->
                </div>
 ...
 <tr> <th>Assignment ID</th> <th>Course</th>  <th>Topic</th>  <th>Description</th>  <th>Date</th>  <th>Upload Type</th>  <th>Assinees</th>
  </tr>
  <tr>
  <td>${msg.assignmentId}</td> <td>${msg.course}</td><td>${msg.topic}</td><td>${msg.description}</td> <td>${msg.date}</td><td>${msg.uploadType}</td>
    <!--  <td>${msg.emailId}</td> -->
 <td><c:forEach items="${msg.emailId}" var="email">${email}<br></c:forEach></td> 
