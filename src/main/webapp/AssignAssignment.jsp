...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 text-right menu-1">
                        <ul>
                            ...
                            <li class="active"><a href="AssignAssignment.jsp">assign</a></li>
    ...
    <div class="container">
                    <div style="margin-top: 100px">
                        ...
                        <h2>${msg}</h2>
            <form action="assignAssignment.ams" method="post"  >
                    <h1 style="background-color:Tomato;">Assign</h1>
                    <p>Please fill below deails to Assign</p>
                    <hr>
                    <div class="form-group row" >
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" placeholder="enter pin" name="pin" required="required">
                            
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-4" style="padding-top: 12px">
                            <label for="assign"><b>assign</b></label>
                        </div>
                        <div class="col-md-7">
                            <!-- <input type="text" class="form-control" placeholder="" name="" required> -->
                            <textarea class="form-control populate" name="emailId" rows="5" cols="10"></textarea>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2"></div>
                     <!-- <div class="col-md-4"> -->
                        <button type="submit" class="col-md-4 signupbtn">Assign</button>
                    <!-- </div> -->
                </div>
